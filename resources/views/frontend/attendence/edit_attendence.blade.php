                                ...
                                @csrf
                                    @foreach($data as $row)
                                        <tr>
                                            ...
                                            @enderror
                                            <td>
                                                <input class="checkbox-circle" type="radio" name="attendence[{{$row->id}}]" value="Present" <?php if($row->attendence=='Present') {echo "checked";}?> > Present
                                                <input  class="checkbox-circle" type="radio" name="attendence[{{$row->id}}]" value="Absent" <?php if($row->attendence=='Absent') {echo "checked";}?>> Absent
                                                @error('attendence')
                                                    <div class="alert alert-danger">{{ $message }}</div>
                                                @enderror
                                            </td>
