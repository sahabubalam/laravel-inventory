                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        <div class="clearfix">
                                            <div class="pull-left">
                                                <h4 class="text-right">It Develop</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                ...
                                                <div class="pull-right m-t-30">
                                                    ...
                                                    <p class="m-t-10"><strong>Order ID: 1</strong> #123456</p>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-md-4"> 
                            <div class="form-group"> 
                                ...
                                <input type="text" class="form-control" id="field-5" name="pay" placeholder="Pay"> 
                        ...
                        <div class="col-md-4"> 
                            <div class="form-group"> 
                                ...
                                <input type="text" class="form-control" id="field-6" name="due" placeholder="Due"> 
